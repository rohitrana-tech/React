...
export default function Card() {
    ...
    const base = "w-full border rounded-lg shadow";
    const light = "bg-white border-gray-200";
    const dark = "bg-gray-800 border-gray-700";
    const textLight = "text-gray-900";
    const textDark = "text-white";

    return (
        <div className={`${base} ${themeMode === 'dark' ? dark : light}`}>
            <a href="/">
            ...
            <div className="px-5 pb-5">
                <a href="/">
                    <h5 className={`text-xl font-semibold tracking-tight ${themeMode === 'dark' ? textDark : textLight}`}>
                ...
                <div className="flex items-center justify-between">
                    <span className={`text-3xl font-bold ${themeMode === 'dark' ? textDark : textLight}`}>$599</span>
                    <a
                        href="/"
